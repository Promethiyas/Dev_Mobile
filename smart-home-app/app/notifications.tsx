      ...
      <View style={{flex: 1}}>
          <ScrollView>
            ...
            <View style={{flexDirection: 'row', position:'absolute'}}>
              <Text style={{borderColor:'black', backgroundColor:'red', marginLeft:'90%', borderRadius:25, color: 'white', marginTop: '11%',fontFamily: 'iransans'}}>{"  3  "}</Text>
            </View>
            <View style={{flexDirection: 'row'}}>
              <Text style= {{marginLeft: '10%', color: '#1C4C9E', textDecorationLine: 'underline', fontFamily:'iransans'}}>{"\n\rAll Notification"}</Text>
              <Text style= {{marginLeft: '12%', color: 'grey',fontFamily:'iransans'}}>{"\n\rUnread"}</Text>
              <Text style= {{marginLeft: '12%', color: 'grey',fontFamily:'iransans'}}>{"\n\rReminder"}</Text>
            </View>
            <Text style={{marginLeft: '5%'}}>{"\n\r"}{getCurrentDate()}</Text>
            {products.map((product, index) => (
              <View key={index} style= {{borderWidth: 2, borderColor: 'white', marginTop: '5%', borderRadius: 10, backgroundColor: 'white'}}>
          ...
          <View style={{position: 'absolute', left: 0, right: 0, bottom: 0, padding: "5%", borderRadius: 11, flexDirection: "row",backgroundColor: "white"}}>
            <View style={{marginLeft: "10%", marginTop: "5%"}}>
              <Link href={"/"}style={{paddingLeft:'2%'}}>
                <Svg width={32}height={32} viewBox="0 0 32 32" fill={'grey'}>
              ...
              <Text style={{position:'absolute', marginTop:'70%',fontFamily: 'iransans'}}>{"Area"}</Text>
            </View>
            <View style={{marginLeft: "10%", marginTop: "4%"}}>
              <Link href={"/scenario"}style={{marginLeft:'15%'}}>
                <Svg width={32}height={32} viewBox="0 0 32 32" fill={'grey'}>
              ...
              <Text style={{fontFamily: 'iransans'}}>{"Scenario"}</Text>
            </View>
            <View style={{marginTop: "4%"}}>
            <View style={{flexDirection: 'row', position:'absolute'}}>
              <Text style={{borderColor:'black', backgroundColor:'red', marginLeft:'50%', borderRadius:25, color: 'white', marginTop: '3%',fontFamily: 'iransans'}}>{"  3  "}</Text>
            </View>
              <Link href={"/notifications"}style={{marginLeft:'20%'}}>
              ...
              <Text style={{fontFamily: 'iransans'}}>{"Notification"}</Text>
            </View>
            <View style={{marginTop: "4%"}} >
              <Link href={"/user"}>
                <Svg width={32}height={32} viewBox="0 0 32 32" fill={'grey'}>
              ...
              <Text style={{fontFamily: 'iransans'}}>{"User"}</Text>
            </View>
          </View>
        </View>
    </View>
